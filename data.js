...
const KEGEL_PROGRAMS = {
  beginner: {
    ...
    // Shared intro video explaining how to find & activate pelvic floor muscles
    introVideo:"https://www.youtube.com/embed/FX1sKCIzKYI?rel=0&modestbranding=1&playsinline=1",
    exercises:[
      {name:"Basic Slow Hold",contract:5,rest:5,reps:8,
       ...
       youtube:"https://www.youtube.com/embed/FX1sKCIzKYI?rel=0&modestbranding=1&playsinline=1&start=0"},
      {name:"Quick Flicks",contract:1,rest:2,reps:10,
       ...
       youtube:"https://www.youtube.com/embed/FX1sKCIzKYI?rel=0&modestbranding=1&playsinline=1&start=90"},
      {name:"Elevator Squeeze",contract:8,rest:8,reps:5,
       ...
       youtube:"https://www.youtube.com/embed/FX1sKCIzKYI?rel=0&modestbranding=1&playsinline=1&start=180"}
    ]
  },
  intermediate: {
    ...
    exercises:[
      {name:"Extended Hold",contract:8,rest:6,reps:10,
       ...
       youtube:"https://www.youtube.com/embed/FX1sKCIzKYI?rel=0&modestbranding=1&playsinline=1"},
